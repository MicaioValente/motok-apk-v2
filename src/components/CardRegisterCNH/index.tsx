...
const PDF = require('../../assets/pdf.jpeg')

export default function CardRegisterCNH({userCPF, setCamera, camera, setCnh, photo, setPhoto, setUser, validade}: CardRegisterCNH ) {
            ...
            {photo &&
                <> 
                    ...
                    <S.ContainerButton>
                        ...
                        {validade && 
                            <InputDataMoment value={userCPF.ValidadeCarteira} mask={'99-99-9999'} border={false} placeholder="Informe a validade da CNH" label="Validade da CNH"  name="ValidadeCarteira" setUser={setUser} />
                        }
                </> 
            }
