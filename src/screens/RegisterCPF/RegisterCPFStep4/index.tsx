...
export default function RegisterCPFStep4({ setStep, step, setUser, postUser }: any) {
    ...
    return (<>
        <S.ContainerScroll>
            <S.Container>
                ...
                <CardRegisterCNH modalExclusao={modalExclusao} setModalExclusao={setModalExclusao} setUser={setUser} setCamera={setCamera} camera={camera} setPhoto={setPhoto} photo={photo} />
