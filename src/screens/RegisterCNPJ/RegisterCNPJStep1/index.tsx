...
export default function RegisterCNPJStep1({ userCNPJ, step, setStep, setUser }: StepProps) {
    ...
    <S.Content>
        ...
        <InputRegister mask={'99.999.999/9999-99'} border={true} placeholder="Informe seu CNPJ" label="Informe seu CNPJ" name="cnpjCliente" setUser={setUser}/>
        {segundaParte &&
            <S.ContainerSegundaParte>
                <InputRegister name="nomeCliente" setUser={setUser} border={false} placeholder="Nome Empresarial" label="Nome Empresarial" />
                ...
                <InputRegister name="InscricaoEstadualCliente" setUser={setUser} border={false} placeholder="Inscrição Estadual" label="Inscrição Estadual" />
                ...
                {/* <InputData name="data_abertura" setUser={setUser} label="Data de Abertura" /> */}
            </S.ContainerSegundaParte>
        }
